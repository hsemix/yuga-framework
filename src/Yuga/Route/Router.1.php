...
class Router
{
    ...
    */
     ...
     * @throws \Yuga\Http\Exceptions\BadFormedUrlException
     */
    public function getUrl($name = null, $parameters = null, $getParams = null)
    {
        ...
        if ($name === null && $parameters === null) {
            return $this->request->getUriCopy()->setParams($getParams);
        }
        ...
        if ($name === null && $loadedRoute !== null) {
            return $this->request->getUriCopy()->setPath($loadedRoute->findUrl($loadedRoute->getMethod(), $parameters, $name))->setParams($getParams);
        }
        ...
        if ($route !== null) {
            return $this->request->getUriCopy()->setPath($route->findUrl($route->getMethod(), $parameters, $name))->setParams($getParams);
        }
        ...
        if (is_string($name) === true && strpos($name, '@') !== false) {
            ...
            foreach ($this->processedRoutes as $route) {
                ...
                if ($route->hasName($controller) === true) {
                    return $this->request->getUriCopy()->setPath($route->findUrl($method, $parameters, $name))->setParams($getParams);
                }
        ...
        return $this->request->getUriCopy()->setPath($url)->setParams($getParams);
    }
